...
const BurgersCard = ({ image, price, reviews, title }: Props) => {
  return (
    <div className='bg-white p-6 rounded-lg m-3 shadow-md'>
      {/* image Div */}
      ...
      Enjoy one of our most popular burgers, the {title}. Made with the finest ingredients, this burger offers a delightful taste experience. Priced at {price},
       it is a must-try for any burger lover!
      </p>

...
const Delivery = () => {
  return <div className='pt-[8rem] pb-[3rem]'>
    <div className='w-[80%] mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-[3rem]'>
        ...
        {/*  Text Content */}
        <div>
            <h1 className='text-[30px] uppercase md:text-[40px] lg:text-[50px] xl:text-[60px] font-bold leading-
            [3rem] md:leading-[4rem]'>
                Your <span className='text-red-600'>Favourite Burger</span> On The
                 Way</h1>
                 <p className='mt-[2rem] text-black text-[17px] text-opacity-70'>
                 Enjoy the best burgers delivered right to your door with fresh ingredients 
                 and unmatched taste!   
                 </p>

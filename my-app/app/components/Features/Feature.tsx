            ...
            <div>
                <div className='p-6 hover:bg-white rounded-lg transition-all duration-200'>
                 ...
                 <h1 className='mt-[1.5rem] text-center text-[24px] text-black font-semibold'>
                    ...
                    Enjoy our delicious and freshly made burgers, 
                    prepared with the finest ingredients to satisfy your cravings.   
                    </p>
                </div>
            </div>
            {/* 2nd Card */}
            <div>
                <div className='p-6 hover:bg-white lg:translate-y-[3rem] rounded-lg transition-all duration-200'>
                 ...
                 <h1 className='mt-[1.5rem] text-center text-[24px] text-black font-semibold'>
                    ...
                    <p className='mt-[0.2rem] text-black text-opacity-60 text-center'>
                    We value your feedback to continue improving our recipes and services. 
            ...
            <div>
                <div className='p-6 hover:bg-white rounded-lg transition-all duration-200'>
                 ...
                 <h1 className='mt-[1.5rem] text-center text-[24px] text-black font-semibold'>
                    ...
                    <p className='mt-[0.2rem] text-black text-opacity-60 text-center'>
                    Each bite is packed with flavor, and our unique blend of spices makes 
                    our chicken burgers stand out.
                    </p>
                </div>
            </div>
        </div>
